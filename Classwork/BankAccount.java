public class BankAccount{
    //instance variables
	//for more sensitive bank account data
    private int accountPin;
	private int amount;//for datas that would be okay to be public
    public String accountHolder;
    public int depositOrWithdrawal;
	...
	public BankAccount(int amount, String accountHolder){ 
		this.amount = amount;
	...
	public BankAccount(int amount, String accountHolder, int depositOrWithdrawal){
		this.amount = amount;
		this.accountHolder = accountHolder;
    ...
    public boolean depositMoney(double amount){
		if (amount < 0){
            System.out.println("Change the bank balance");//if the amount to deposit is negative, is it TRUE or FALSE that we can deposit, and should we change the bank balance?
